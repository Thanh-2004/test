...
with open('AI/Gradient_1.pkl', 'rb') as file:
...
s = open("/Users/nguyentrithanh/Documents/Lab/EEG_AwakeDrive/test/Data/Dat1/task5.txt", 'rb')
print("START!")
